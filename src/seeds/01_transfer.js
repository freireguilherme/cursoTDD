...
exports.seed = (knex) => {
  ...
  return knex('transactions').del()
    ...
    .then(() => knex('users').insert([
      { id: 10000, name: 'User #1', mail: 'user1@mail.com', passwd: '$2a$10$QRUOMAniPfqR1HGOTcTqtuasWY3ab7KqKXbtgEFF8eTF.DFbrFzG6' },
      { id: 10001, name: 'User #2', mail: 'user2@mail.com', passwd: '$2a$10$QRUOMAniPfqR1HGOTcTqtuasWY3ab7KqKXbtgEFF8eTF.DFbrFzG6' },
    ]))
